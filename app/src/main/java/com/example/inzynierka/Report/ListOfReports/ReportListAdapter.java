...
public class ReportListAdapter extends RecyclerView.Adapter<ReportListAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        ImageView imageViewMainPhoto = holder.imageViewMainPhoto;
        Log.e("Report adapter", getItemCount()+"");
            ...
            String titleString = "<b>" + TITLE + "</b> " + title;
            textViewTitle.setText(Html.fromHtml(titleString));
            if (date != null) {
                String dateString = "<b>" + DATA + "</b> " + date;
                textViewDate.setText(Html.fromHtml(dateString));
            }
            if (localization != null) {
                String sourceString = "<b>" + LOCALIZATION + "</b> " + localization;
                textViewLocaliztion.setText(Html.fromHtml(sourceString));
            }
