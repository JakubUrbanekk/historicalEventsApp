...
public class PhotosAdapter extends RecyclerView.Adapter<PhotosAdapter.ViewHolder> {
    ...
    Fragment context;
    ImageView mainPhoto;
    ViewModelMainPhoto reportViewModel;
    TextInputLayout textInputLayout;
    TextInputEditText textInputEditText;

    public PhotosAdapter(Fragment context, ImageView mainPhoto, ViewModelMainPhoto reportViewModel, TextInputLayout textInputLayout, TextInputEditText textInputEditText){
